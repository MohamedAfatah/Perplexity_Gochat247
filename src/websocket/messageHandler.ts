...
export const searchHandlers = {
  ...
  //   summarizer: false,
  // }),
  chatWithModel: new MetaSearchAgent({
    activeEngines: [],
    queryGeneratorPrompt: '',
    responsePrompt: prompts.chatWithModelPrompt,
    rerank: true,
    rerankThreshold: 0,
    searchWeb: false,
    summarizer: false,
  ...
  //   summarizer: false,
  // }),
    chatWithDB: new MetaSearchAgent({
    activeEngines: ['reddit'],
    queryGeneratorPrompt: prompts.chatWithDBQueryGenerationPrompt,
    responsePrompt: prompts.chatWithDBAnswerPrompt,
    rerank: true,
    rerankThreshold: 0.3,
    searchWeb: true,
    summarizer: false,
